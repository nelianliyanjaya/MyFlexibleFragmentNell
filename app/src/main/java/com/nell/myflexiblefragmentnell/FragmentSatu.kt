package com.nell.myflexiblefragmentnell
...
class FragmentSatu : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnDua.setOnClickListener{
            val bundle = Bundle()
            bundle.putString(FragmentDua.EXTRA_NAME,"Ini Data dari Fragment Satu Nell")
            val desc = "Fragment ini akan menerima Data dari Fragment Satu Nell"
